...
export const RunLogModal: React.FC<RunLogModalProps> = ({ onClose, plannedRun }) => {
  ...
  const [distance, setDistance] = useState<string>(plannedRun?.distance.toString() || '');
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const durNum = parse(duration);
    const pace = calculatePace(distNum, durNum);
