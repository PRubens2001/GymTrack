            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex gap-3 mt-1">
                  ...
                  <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">G: {meal.fat}g</span>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-4">
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-zinc-900 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-in">
        ...
        <form 
          onSubmit={(e) => {
            e.preventDefault();
            onSave({ name, kcal, prot, carb, fat });
          }}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-wider text-zinc-400">Gorduras (g)</label>
              <input 
                type="number" 
                value={fat || ''}
