...
export const WorkoutSection: React.FC = () => {
  ...
  const handleFinishWorkout = async () => {
    const records = groups.flatMap(g => 
      g.exercises
        .filter(e => (e.exercise || e.newExerciseName) && e.weight > 0 && e.reps > 0)
        .map(e => ({
          group: g.group,
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            <input 
                              ...
                              onChange={(e) => handleUpdateExercise(group.id, exercise.id, { weight: parseFloat(e.target.value) || 0 })}
                        ...
                        <div className="space-y-1.5">
                          ...
                          <input 
                            type="number" 
                            value={exercise.reps || ''}
                            onChange={(e) => handleUpdateExercise(group.id, exercise.id, { reps: parseInt(e.target.value) || 0 })}
