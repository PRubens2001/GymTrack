...
import { User, X, Library, Moon, Sun, LogOut, Database, ShieldCheck, UserCircle } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onOpenGallery }) => {
  ...
  return (
    <>
      ...
      {isPersonalInfoOpen && <PersonalInfoModal onClose={() => setIsPersonalInfoOpen(false)} />}
    </>
  );
};
