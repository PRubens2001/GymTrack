          ...
          <div key={day.date} className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden transition-all">
            ...
            >
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="hidden sm:flex flex-wrap items-center gap-x-4 gap-y-1 border-l border-zinc-100 dark:border-zinc-800 pl-4">
                  ...
                  <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">GT: {Math.round(day.totals.fat_total)}g</span>
                  <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest text-rose-500/70">GS: {Math.round(day.totals.fat_sat)}g</span>
                  <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest text-emerald-500/70">F: {Math.round(day.totals.fiber)}g</span>
                </div>
              </div>
            </button>
                  ...
                  <div key={meal.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-white dark:hover:bg-zinc-800 transition-all">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {meal.description && (
                          <p className="text-[10px] text-zinc-500 dark:text-zinc-400 italic line-clamp-1 mb-0.5">{meal.description}</p>
                        )}
                        <div className="flex flex-wrap gap-x-2 gap-y-0.5 mt-0.5">
                          ...
                          <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">GT: {meal.fat_total}g</span>
                          <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest text-rose-500/70">GS: {meal.fat_sat}g</span>
                          <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest text-emerald-500/70">F: {meal.fiber}g</span>
                        </div>
                      </div>
                    </div>
