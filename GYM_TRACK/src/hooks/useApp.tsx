...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const loadAllData = useCallback(async (currUser: any) => {
    ...
    try {
      ...
      if (profileRes.data) {
        ...
        // Use upsert to be safe and select to get the created record
        ...
        if (insertError) {
          throw new Error(`Erro ao criar perfil: ${insertError.message}. Certifique-se de ter executado o script SQL no Supabase.`);
        }
  ...
  return (
    <AppContext.Provider value={{
      ...
      addRun, deleteRun, addPlannedRun, deletePlannedRun, updatePlannedRun, addMeal, deleteMeal, updateWater, updateDietGoals,
